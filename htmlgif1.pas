...
type
  ...
  TGifZip = record
    ...
    rPrefix: array[0..kGifCodeTableSize - 1] of integer;
    // string prefixes
    rSuffix: array[0..kGifCodeTableSize - 1] of integer;
    // string suffixes
    rCodeStack: array[0..kGifCodeTableSize - 1] of byte;
    ...
    rBitString: integer;
    // steady stream of bits to be decoded
...
type
  ...
  public
    ...
    property ImageDelay[Image: integer]: integer
      read GetImageDelay;
    property ImageDisposal[Image: integer]: integer
      read GetImageDisposal;

    property Transparent: boolean
      read GetTransparent;
    property TransparentIndex[Image: integer]: integer
      read GetTransparentIndex;
    property TransparentColor: TColor
      read GetTransparentColor;
    property ImageLeft[Image: integer]: integer
      read GetImageLeft;
    property ImageTop[Image: integer]: integer
      read GetImageTop;
...
begin
  ...
  begin
    ...
    begin
      ...
      ReadSourceInteger(1, rText.rCellWidth);
      // character cell size    {LDB}{was 2 bytes}
        ...
        begin
          ...
          {find the start of each frame row in destination.  Note that the source
           ...
           imagetop and imageleft}
            ...
            begin
              if P < PRight then
                {prevent write beyond proper right side in case rwidth to wide}
              begin
